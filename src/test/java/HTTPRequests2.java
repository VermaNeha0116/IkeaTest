...
public class HTTPRequests2 {
    ...
    public void verifyUser() {
	  ...
	  @Description("Test Description : Verify the creation of a new user") public
	  void createUser() {
	  
	  JSONObject data = new JSONObject();
	  
	  data.put("name", "RestAPITest"); data.put("job", "Testing");
	  ...
	  // THEN
	  .then() .statusCode(201) .body("name", equalTo("RestAPITest"))
